  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \postauthor{\par\vskip 0.5em{\normalsize\color{gray} Matriculation Number: 12340635}\par\vskip 1.5em{\normalsize\color{bokublue}\bfseries University of Natural Resources and Life Sciences, Vienna (BOKU)}\par\vskip 1.5em{\normalsize Submitted to: \textbf{Mathew Herrnegger}}\end{center}\vskip 3em}
