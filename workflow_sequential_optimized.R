# =============================================================================
# OPTIMIZED SEQUENTIAL SENSITIVITY ANALYSIS WORKFLOW
# =============================================================================
...
cat("=============================================================================\n")
cat("COSERO SEQUENTIAL SENSITIVITY ANALYSIS - OPTIMIZED WORKFLOW\n")
cat("=============================================================================\n\n")
...
n_samples <- 100  # Base sample size (Total simulations = n × (k+2) where k=parameters)
...
# Visualization settings (Publication-ready)
viz_dpi <- 600           # High resolution for publications
viz_width <- 16          # inches
viz_height <- 12         # inches
viz_sobol_width <- 14
viz_sobol_height <- 8
...
# Physical bounds (min/max) define the physically realistic range
# Sample bounds (sample_min/sample_max) define the Sobol sampling range
# modification_type: "relchg" = relative change (multiply), "abschg" = absolute change (add)
...
batch_dir <- file.path(project_path, "temp_sequential_batches")
...
# =============================================================================
# STEP 8: PUBLICATION-READY VISUALIZATIONS
# =============================================================================

cat("\n=============================================================================\n")
cat("STEP 8: PUBLICATION-READY VISUALIZATIONS\n")
cat("=============================================================================\n\n")
...
# ------------------------
# 8.6: Best NSE Simulation Dotty Plot
# ------------------------
...
# ------------------------
# 8.7: Best KGE Simulation Dotty Plot
# ------------------------
...
# ------------------------
# 8.10: NSE vs KGE Sobol Comparison
# ------------------------
...
# ------------------------
# 8.11: Best Simulations Hydrographs
# ------------------------
...
# ------------------------
# 8.12: Behavioral Parameter Ranges
# ------------------------
...
# ------------------------
# 8.13: Parameter Constraints Table
# ------------------------
...
if (n_behavioral > 10) {
  ...
  param_constraints <- data.frame(
    ...
    Best_NSE_Value = sapply(param_names, function(p) absolute_params[[p]][best_nse_idx_plot]),
    Best_KGE_Value = sapply(param_names, function(p) absolute_params[[p]][best_kge_idx_plot])
  )
...
# =============================================================================
# STEP 9: IDENTIFY AND EXPORT BEST PARAMETER SETS
# =============================================================================

cat("=============================================================================\n")
cat("STEP 9: BEST PARAMETER SETS IDENTIFICATION AND EXPORT\n")
cat("=============================================================================\n\n")
...
# =============================================================================
# STEP 10: REMOVED - No CSV exports needed
# =============================================================================
# All results are saved in RDS format and visualizations
# CSV exports have been removed per user request
...
cat("=============================================================================\n")
cat("STEP 10: ANALYSIS REPORT GENERATION\n")
cat("=============================================================================\n\n")
...
cat("✓ Sequential sensitivity analysis completed successfully\n\n")
